...
export default async function CashFlowDetailPage({ params }: { params: { id: string } }) {
  ...
  const formData: CashFlowFormData = {
    ...
    structurationApplyTo: stringToActor(bond.structuration_apply_to),
    colocationApplyTo: stringToActor(bond.colocation_apply_to),
    flotationApplyTo: stringToActor(bond.flotation_apply_to),
    cavaliApplyTo: stringToActor(bond.cavali_apply_to),
